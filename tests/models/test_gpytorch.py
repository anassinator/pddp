"""Unit tests for pddp.models.gpytorch."""

import torch
import pytest

from pddp.models.gpytorch import *
...
def _setup(encoding):
    model = gpytorch_dynamics_model_factory(STATE_SIZE, ACTION_SIZE)()
...
def test_gradcheck(encoding):
    ...
    # TODO: Enable this when GPytorch supports doubles...
    # model.double()
    # Z = Z.double()
    # U = U.double()
